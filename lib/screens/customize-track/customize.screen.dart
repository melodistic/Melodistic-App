                    ...
                    Expanded(
                        child: Column(
                          ...
                          TextFieldWidget(
                            ...
                            validate:
                                trackCustomizeController.validateProgramName,
                          ),
                          kSizedBoxVerticalM,
                          ...
                          Obx(() {
                            if (trackCustomizeController.errorMessage.value !=
                                null) {
                            ...
                            children: <Widget>[
                              Obx(() => ScrollableSelectWidget(
                                    ...
                                    onChange: (OptionItem value,
                                      ...
                                      trackCustomizeController
                                          .selectMuscleGroup(value, controller);
                                    },
                                  ))
                            ],
                          )
                    ...
                    ButtonWidget(
                      ...
                      handleClick: () {
                        if (trackCustomizeController
                                ...
                                .validate() &&
                            trackCustomizeController.validateProgramPicture()) {
                          String programName = _programController.text;
                          trackCustomizeController.setProgramName(programName);
