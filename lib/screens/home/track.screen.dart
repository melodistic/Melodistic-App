    ...
    return ScreenWrapper(
        customAppbar: BackActionAppbar(
          ...
          action: GestureDetector(
              ...
              child: Obx(() => playerController.currentTrack.value != null &&
                      playerController.currentTrack.value!.isFav
        ...
        child: Obx(() => playerController.currentTrack.value != null
            ? Column(
                ...
                children: <Widget>[
                  Container(
                      height:
                          min(450, MediaQuery.of(context).size.height * 0.5),
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.symmetric(horizontal: kSizeS * 1.5),
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          Text(
